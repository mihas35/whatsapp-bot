...
const smsPremium = () => { return `\`\`\`ЭТА КОМАНДА ДОСТУПНА ТОЛЬКО ДЛЯ ПРЕМИУМ-ПОЛЬЗОВАТЕЛЕЙ И МОЕГО СОЗДАТЕЛЯ!\`\`\`` }
...
const smsUnreg = () => { return `\`\`\`ВЫ ДОЛЖНЫ БЫТЬ ЗАРЕГИСТРИРОВАНЫ ЧТОБЫ ИСПОЛЬЗОВАТЬ ЭТУ КОМАНДУ!\`\`\`` }
